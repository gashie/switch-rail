...
ItemModuleDeferred fromNotesReal PAPSS production integrationcrossborder-railsPhase 9Requires BoG accreditation. Simulator is the canonical contract; real adapter slots into the same shape.Real BIS Nexus integrationcrossborder-railsPhase 9System still in build globally. Simulator covers the contract.Real e-Cedi CBDC integrationsettlement-assetsPhase 9Pilot since Sept 2022. Fake adapter ships; real one when BoG opens production access.Real stablecoin issuer integrationsettlement-assetsPhase 9Regulatory clarity needed first.SWIFT gpi trackingcrossborder-txPhase 9Requires commercial SWIFT relationship.Multi-currency treasury optimizationcrossborder-fxPhase 9Phase 11+.Cross-jurisdiction sanctions auto-resolverscrossborder-travel-rulePhase 9Phase 11+.